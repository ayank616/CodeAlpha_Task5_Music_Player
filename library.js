function inputs(userName, bookName, type) {
  ...
  function formSubmit(e) {
    ...
    let checkPrograming = document.getElementById("Non-Fiction");
    if (checkFiction.checked) {
      givenType = checkFiction.value;
    } else if (checkNon-Fictiong.checked) {
      givenType = checkNon-Fiction.value;
    }  
    ...
    if (displayObj.validate(o1) && displayObj.checkIssue(listArray, o1) == 1) {
      ...
      displayObj.alertuser("Alert", "Oops!", "Book is not issued");
      displayObj.clear();
    }
  }